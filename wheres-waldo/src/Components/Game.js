...
export function Game(props) {
  return (
    <div className="relative">
      <GameHeader waldoFound={props.waldoFound} odlawFound={props.odlawFound} wizardFound={props.wizardFound} handleTimerStop={props.handleTimerStop} setIsStart={props.setIsStart}/>
